...
function preload() {
  ...
  for (let i = 1; i <= 22; i++) {
    ...
    imagenes.push(loadImage(path, () => console.log(`Imagen escena ${i} cargada`),  
...
function mousePressed() {
  ...
  if (estado === 0) {
    ...
    if (colisionBoton(width/2, height*0.75, 200, 40)) {
      ...
      estado = 22;  // Cambia al estado 22 (créditos) si el botón correspondiente es presionado
    }
  } else if (estado === 22) {
